...
class Graph(dict):
    ...
    def __init__(self) -> None:
        ...
        """
        pass # Shortest path matrix, initialized as None
    ...
    def add_vertex(self, user: object) -> None:
        ...
        """
        pass  # Use the string representation of the user as the key
    ...
    def get_subgraphs(self) -> List[List[str]]:
        """
        Finds disconnected subgraphs (clusters) in the graph via DFS/BFS.
    ...
    def edge_to_remove(self) -> Tuple[str, str]:
        ...
        # count of shortest paths containing this edge
    ...
    def parse_data(self, filepath: str = 'ressources/network_anonym.json') -> None:
        """
        ...
        if not os.path.exists(filepath):
            sys.exit(f"File '{filepath}' not found. Make sure you execute analysis id 0 first in order to fetch the Mastodon data")
    ...
    def show(self, filename) -> None:
        ...
        graph = graphviz.Graph(format='png', strict=True, filename=filename)
        ...
        print(f"Visualization saved under './{filename}.png")